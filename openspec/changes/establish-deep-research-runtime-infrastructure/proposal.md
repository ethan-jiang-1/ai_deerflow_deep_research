...
- Register the new requirement IDs `PRS-001` through `PRS-003`, `DEC-001` through `DEC-005`, `RUI-001` through `RUI-005`, and `NOA-001` through `NOA-006`.
...
- `project-structure`: Defines and enforces the canonical downstream package, import direction, node package, test mirror, and shared-code ownership contracts (`PRS-001`..`PRS-003`).
