...
- Reserve a Wave1 final-answer turn by narrowing only its request-level tool window from three calls to two, retaining its existing separate zero-tool structured repair and shared execution policy.
