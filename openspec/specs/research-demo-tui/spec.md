...
## Purpose
Provide a bounded, standalone terminal visualization of the Deep Research real-mode lifecycle without implying production DeerFlow TUI, Web UI, Gateway, or generic human-input integration.
